...
<%-- <%
	...
	int pNo = vo.getProdNo();
	String pName = vo.getProdName();
	String pDetail = vo.getProdDetail();
	int pPrice = vo.getPrice();
	String pMdate = vo.getManuDate();
	String pFileName = vo.getFileName();
%> --%>
...
<%-- <input type="hidden" name="prodNo" value="<%= pNo %>"/> --%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
				...
				<tr>
					<td width="105">
						<%-- <input 	type="text" name="prodName" class="ct_input_g" 
										style="width: 100px; height: 19px" maxLength="20" value="<%= pName %>"> --%>
						<input 	type="text" name="prodName" class="ct_input_g" 
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<%-- <input type="text" name="prodDetail" value="<%= pDetail %>" class="ct_input_g" 
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<%-- <input type="text" readonly="readonly" name="manuDate" value="<%= pMdate %>" 	
	...
	<tr>
		...
		<td class="ct_write01">
			<%-- <input	type="text" name="fileName" class="ct_input_g" 
						style="width: 200px; height: 19px" maxLength="13" value="<%= pFileName %>"/> --%>
			<input	type="text" name="fileName" class="ct_input_g" 
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
						<c:if test="${ ! empty vo.proTranCode && fn:trim(vo.proTranCode)=='0' }">
							<a href="javascript:fncAddProduct();">수정</a>
						</c:if>
						<c:if test="${ ! empty vo.proTranCode && fn:trim(vo.proTranCode)=='3' }">
